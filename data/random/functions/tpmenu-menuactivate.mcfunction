...
#Menu Activate user4
execute as @a[tag=user4,scores={SneakTime=16}] if score @p[tag=user4] tyr.used.slot matches 1 run tp @s -195 66 -34 180 11
execute as @a[tag=user4,scores={SneakTime=16}] if score @p[tag=user4] tyr.used.slot matches 1 run msg @s Teleported to Spawn!
...
execute as @a[tag=user4] if score @p[tag=user4] SneakTime matches 16.. run scoreboard players set @s SneakTime 0


#Menu Activate user5
execute as @a[tag=user5,scores={SneakTime=16}] if score @p[tag=user5] tyr.used.slot matches 1 run tp @s -195 66 -34 180 11
execute as @a[tag=user5,scores={SneakTime=16}] if score @p[tag=user5] tyr.used.slot matches 1 run msg @s Teleported to Spawn!
...
execute as @a[tag=user5] if score @p[tag=user5] SneakTime matches 16.. run scoreboard players set @s SneakTime 0


#Menu Activate user6
execute as @a[tag=user6,scores={SneakTime=16}] if score @p[tag=user6] tyr.used.slot matches 1 run tp @s -195 66 -34 180 11
execute as @a[tag=user6,scores={SneakTime=16}] if score @p[tag=user6] tyr.used.slot matches 1 run msg @s Teleported to Spawn!
...
execute as @a[tag=user6] if score @p[tag=user6] SneakTime matches 16.. run scoreboard players set @s SneakTime 0


#Menu Activate user7
execute as @a[tag=user7,scores={SneakTime=16}] if score @p[tag=user7] tyr.used.slot matches 1 run tp @s -195 66 -34 180 11
execute as @a[tag=user7,scores={SneakTime=16}] if score @p[tag=user7] tyr.used.slot matches 1 run msg @s Teleported to Spawn!
...
execute as @a[tag=user7] if score @p[tag=user7] SneakTime matches 16.. run scoreboard players set @s SneakTime 0


#Menu Activate user8
execute as @a[tag=user8,scores={SneakTime=16}] if score @p[tag=user8] tyr.used.slot matches 1 run tp @s -195 66 -34 180 11
execute as @a[tag=user8,scores={SneakTime=16}] if score @p[tag=user8] tyr.used.slot matches 1 run msg @s Teleported to Spawn!
...
execute as @a[tag=user8] if score @p[tag=user8] SneakTime matches 16.. run scoreboard players set @s SneakTime 0


#Menu Activate user9
execute as @a[tag=user9,scores={SneakTime=16}] if score @p[tag=user9] tyr.used.slot matches 1 run tp @s -195 66 -34 180 11
execute as @a[tag=user9,scores={SneakTime=16}] if score @p[tag=user9] tyr.used.slot matches 1 run msg @s Teleported to Spawn!
...
execute as @a[tag=user9] if score @p[tag=user9] SneakTime matches 16.. run scoreboard players set @s SneakTime 0
