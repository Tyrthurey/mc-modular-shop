...
# execute as @a[nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{tag=!user,display:{Name:'{"text":"Teleport Key","color":"dark_purple","bold":true,"italic":false}',Lore:['{"text":"With this key you can teleport. Tyr\'s Item Only. No Touchy."}']}}}]}] run tag @s add user2
# execute unless score Database UserCount matches 2.. if entity @a[tag=user2] run scoreboard players set Database UserCount 2
# execute as @a[nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{tag=!user,tag=!user2,display:{Name:'{"text":"Teleport Key","color":"dark_purple","bold":true,"italic":false}',Lore:['{"text":"With this key you can teleport. Tyr\'s Item Only. No Touchy."}']}}}]}] run tag @s add user3
