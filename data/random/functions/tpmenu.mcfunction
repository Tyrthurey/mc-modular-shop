...
#Flashy circles
execute at @a[tag=user] as @a[tag=user] if score @s tyr.used.slot matches 1 run function random:circles/goldsmallstarcircle
execute at @a[tag=user] as @a[tag=user] if score @s tyr.used.slot matches 2 run function random:circles/cyansimplestarcircle
execute at @a[tag=user] as @a[tag=user] if score @s tyr.used.slot matches 8 run function random:circles/redcircle
