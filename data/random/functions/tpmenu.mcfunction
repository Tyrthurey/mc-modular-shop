#Tag or no tag
execute as @a[nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] unless entity @a[tag=user] run tag @s add user
# execute unless score Database UserCount matches 1.. if entity @a[tag=user] run scoreboard players set Database UserCount 1
execute as @a[tag=!user,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] unless entity @a[tag=user2] run tag @s add user2
# execute unless score Database UserCount matches 2.. if entity @a[tag=user2] run scoreboard players set Database UserCount 2
execute as @a[tag=!user,tag=!user2,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] unless entity @a[tag=user3] run tag @s add user3
# execute unless score Database UserCount matches 3.. if entity @a[tag=user3] run scoreboard players set Database UserCount 2
# execute as @a[nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] if entity @a[tag=user] if entity @a[tag=user2] if entity @a[tag=user3] run tag @s add user4
...
# execute as @a[nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] if entity @a[tag=user] if entity @a[tag=user2] if entity @a[tag=user3] if entity @a[tag=user4] if entity @a[tag=user5] if entity @a[tag=user6] run tag @s add user7
# execute as @a[nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] if entity @a[tag=user] if entity @a[tag=user2] if entity @a[tag=user3] if entity @a[tag=user4] if entity @a[tag=user5] if entity @a[tag=user6] if entity @a[tag=user7] run tag @s add user8
# execute as @a[nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] if entity @a[tag=user] if entity @a[tag=user2] if entity @a[tag=user3] if entity @a[tag=user4] if entity @a[tag=user5] if entity @a[tag=user6] if entity @a[tag=user7] if entity @a[tag=user8] run tag @s add user9

execute unless entity @a[tag=user,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] run tag @a[tag=user] remove user
execute unless entity @a[tag=user2,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] run tag @a[tag=user2] remove user2
execute unless entity @a[tag=user3,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] run tag @a[tag=user3] remove user3
execute unless entity @a[tag=user4,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] run tag @a[tag=user4] remove user4
execute unless entity @a[tag=user5,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] run tag @a[tag=user5] remove user5
execute unless entity @a[tag=user6,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] run tag @a[tag=user6] remove user6
execute unless entity @a[tag=user7,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] run tag @a[tag=user7] remove user7
execute unless entity @a[tag=user8,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] run tag @a[tag=user8] remove user8
execute unless entity @a[tag=user9,nbt={Inventory:[{id:"minecraft:amethyst_shard",Slot:-106b,tag:{display:{Name:'[{"text":"Control Crystal","italic":false,"bold":true,"color":"dark_purple"}]',Lore:['[{"text":"With this key, you get access to the","italic":true,"color":"gold"}]','[{"text":"control menu. This is an Admin Item.","italic":true,"color":"gold"}]','[{"text":"Mere mortals are not allowed to touch","italic":true,"color":"gold"}]','[{"text":"this sacred artefact.","italic":true,"color":"gold"}]']}}]}] run tag @a[tag=user9] remove user9
