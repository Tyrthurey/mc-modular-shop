...
execute if score Spawn tyr.spawn.limit matches 0 at @a[tag=user] run summon armor_stand ^ ^ ^4 {CustomNameVisible:1b,NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Marker:0b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,ArmorItems:[{},{},{},{id:"minecraft:grass_block",Count:1b}],Tags:["spawn"],CustomName:'{"text":"Spawn","color":"gold","bold":true,"italic":false}'}
execute if score Shops tyr.spawn.limit matches 0 at @a[tag=user] run summon armor_stand ^ ^ ^4 {CustomNameVisible:1b,NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,Marker:0b,Invisible:1b,NoBasePlate:1b,PersistenceRequired:1b,ArmorItems:[{},{},{},{id:"minecraft:stone",Count:1b}],Tags:["shops"],CustomName:'{"text":"Shops","color":"gold","bold":true,"italic":false}'}
