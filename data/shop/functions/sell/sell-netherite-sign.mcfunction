...
execute if score Database ShopSellTrigger matches 11 at @e[tag=ZP-Converter-Sign-11] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] ZPoints 500
...
execute if score Database ShopSellTrigger matches 12 at @e[tag=ZP-Converter-Sign-12] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] ZPoints 500
