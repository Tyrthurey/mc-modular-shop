...
execute if score Database ShopSellTrigger matches 1 at @e[tag=ZP-Converter-Sign-1] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 2 at @e[tag=ZP-Converter-Sign-2] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 3 at @e[tag=ZP-Converter-Sign-3] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 4 at @e[tag=ZP-Converter-Sign-4] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 5 at @e[tag=ZP-Converter-Sign-5] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 6 at @e[tag=ZP-Converter-Sign-6] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 7 at @e[tag=ZP-Converter-Sign-7] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 8 at @e[tag=ZP-Converter-Sign-8] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 9 at @e[tag=ZP-Converter-Sign-9] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 10 at @e[tag=ZP-Converter-Sign-10] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
...
execute if score Database ShopSellTrigger matches 11 at @e[tag=ZP-Converter-Sign-11] run msg @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] 1 Netherite Ingot Accepted - 500 Points Added
execute if score Database ShopSellTrigger matches 11 at @e[tag=ZP-Converter-Sign-11] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
execute if score Database ShopSellTrigger matches 11 at @e[tag=ZP-Converter-Sign-11] run clear @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] netherite_ingot 1

execute if score Database ShopSellTrigger matches 12 at @e[tag=ZP-Converter-Sign-12] run msg @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] 1 Netherite Ingot Accepted - 500 Points Added
execute if score Database ShopSellTrigger matches 12 at @e[tag=ZP-Converter-Sign-12] run scoreboard players add @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] Starz 500
execute if score Database ShopSellTrigger matches 12 at @e[tag=ZP-Converter-Sign-12] run clear @p[tag=Seller,nbt={SelectedItem:{id:"minecraft:netherite_ingot"}}] netherite_ingot 1
